      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-lg p-6 md:p-8">
        ...
        <div className="bg-gray-50 rounded-2xl p-5 shadow-inner">
          <div className="flex items-center gap-3 text-sm md:text-base">
            ...
            <span className="font-medium text-gray-700">(9.5K+ ratings)</span>
            <span className="text-gray-400">•</span>
            <span className="font-semibold text-gray-800">₹350 for two</span>
          </div>

          <p className="text-orange-600 font-medium mt-3">Pizzas</p>
